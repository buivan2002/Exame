...
class ChartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chart" do
    assert_difference("Chart.count") do
      post charts_url, params: { chart: { age: @chart.age, email: @chart.email, name: @chart.name } }
    end
  ...
  test "should update chart" do
    patch chart_url(@chart), params: { chart: { age: @chart.age, email: @chart.email, name: @chart.name } }
